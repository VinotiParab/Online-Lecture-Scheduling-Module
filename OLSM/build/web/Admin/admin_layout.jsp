<%-- 
    ...
    Created on : Jan 26, 2021, 12:51:50 AM
    Author     : VINOTI
--%>
...
<body style="font-family:Verdana; background-color: #e5e5e5;">
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href="main_admin.jsp">Home</a>
        <a href="add_course.jsp">Add Course</a>
        <a href="list_course.jsp">List of Courses</a>
        <a href="add_instructor.jsp">Add Instructor</a>
        <a href="list_instructor.jsp">List of Instructor</a>
        <a href="add_lecture.jsp">Schedule Lecture</a>
        <a href="list_lecture.jsp">List of Lecture</a>
    </div>
